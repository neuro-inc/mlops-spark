...
|:--------------- |:----------- |:----------- |:-------------------------- |
| `data/` | Data | `storage:mlops_spark/data/` | `/mlops_spark/data/` |
| `modules/` | Python modules | `storage:mlops_spark/modules/` | `/mlops_spark/modules/` |
| `config/` | Configuration files | `storage:mlops_spark/config/` | `/mlops_spark/config/` |
| `notebooks/` | Jupyter notebooks | `storage:mlops_spark/notebooks/` | `/mlops_spark/notebooks/` |
| `results/` | Logs and results | `storage:mlops_spark/results/` | `/mlops_spark/results/` |
...
After the storage folders have been created, run `neuro-flow upload data` from the a local machine as well. This command pushes local files stored in `./data` into the `storage:mlops_spark/data` volume mounted to your development environment's `/project/data`.
